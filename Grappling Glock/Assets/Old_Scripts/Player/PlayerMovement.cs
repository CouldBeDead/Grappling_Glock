...
public class PlayerMovement : MonoBehaviour {
    ...
    public AudioSource slideAudio; // Drag audio clip here in Inspector
    ...
    if (crouching && grounded && speed > minSpeedForAudio) {
        // Set volume proportionally to speed
        slideAudio.volume = Mathf.Clamp01(speed / maxSpeed) * maxSlideVolume;
    } else {
        // Fade out and stop when not sliding
